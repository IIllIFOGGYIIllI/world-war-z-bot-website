...
This separate optional webhook posts website repository updates into a Discord channel whenever files are committed to GitHub. It is not used by the dashboard-managed moderation notification system in version 1.19.0.
